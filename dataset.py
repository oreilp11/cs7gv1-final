...
plt.plot(baseline['epoch'], baseline['train/box_loss'], label='train')
plt.plot(baseline['epoch'], baseline['val/box_loss'], label='val')
plt.ylabel("Box Loss")
plt.legend()

plt.subplot(3,1,2)
plt.title("Baseline YOLOv10 Class Loss")
plt.plot(baseline['epoch'], baseline['train/cls_loss'], label='train')
plt.plot(baseline['epoch'], baseline['val/cls_loss'], label='val')
plt.ylabel("Class Loss")
plt.legend()

plt.subplot(3,1,3)
plt.title("Baseline YOLOv10 DFL Loss")
plt.plot(baseline['epoch'], baseline['train/dfl_loss'], label='train')
plt.plot(baseline['epoch'], baseline['val/dfl_loss'], label='val')
plt.xlabel("Epochs")
plt.ylabel("DFL Loss")
plt.legend()
plt.tight_layout()
...
plt.plot(seyolo['epoch'], seyolo['train/box_loss'], label='train')
plt.plot(seyolo['epoch'], seyolo['val/box_loss'], label='val')
plt.ylabel("Box Loss")
plt.legend()

plt.subplot(3,1,2)
plt.title("SE-YOLOv10 Class Loss")
plt.plot(seyolo['epoch'], seyolo['train/cls_loss'], label='train')
plt.plot(seyolo['epoch'], seyolo['val/cls_loss'], label='val')
plt.ylabel("Class Loss")
plt.legend()

plt.subplot(3,1,3)
plt.title("SE-YOLOv10 DFL Loss")
plt.plot(seyolo['epoch'], seyolo['train/dfl_loss'], label='train')
plt.plot(seyolo['epoch'], seyolo['val/dfl_loss'], label='val')
plt.xlabel("Epochs")
plt.ylabel("DFL Loss")
plt.legend()
plt.tight_layout()
